...
tests/product_source/test_extractor_dom_fixtures.py::test_shopee_obfuscated_live_dom_gallery_extraction_and_footer_exclusion PASSED [  6%]
tests/product_source/test_models.py::test_build_source_pack_id_with_product_id PASSED [  8%]
tests/product_source/test_models.py::test_build_source_pack_id_fallback_url PASSED [ 10%]
tests/product_source/test_models.py::test_build_source_pack_id_determinism PASSED [ 12%]
tests/product_source/test_models.py::test_build_source_pack_id_ignores_tracking_and_auth_noise PASSED [ 14%]
tests/product_source/test_models.py::test_sanitize_url_redacts_sensitive_parameters PASSED [ 16%]
tests/product_source/test_models.py::test_product_fact_validation PASSED [ 18%]
tests/product_source/test_models.py::test_product_fact_frozen PASSED     [ 20%]
tests/product_source/test_models.py::test_original_media_ref_validation PASSED [ 22%]
tests/product_source/test_models.py::test_product_source_pack_validation PASSED [ 24%]
tests/product_source/test_models.py::test_description_text_bounded PASSED [ 26%]
tests/product_source/test_models.py::test_facts_media_auto_converted_to_tuples PASSED [ 28%]
tests/product_source/test_models.py::test_product_source_pack_to_dict_secret_safe PASSED [ 30%]
tests/product_source/test_models.py::test_enums_values PASSED            [ 32%]
tests/product_source/test_models.py::test_error_hierarchy PASSED         [ 34%]
tests/product_source/test_original_media_downloader.py::test_preserves_exact_original_bytes PASSED [ 36%]
tests/product_source/test_original_media_downloader.py::test_streaming_oversize_media_aborts_early PASSED [ 38%]
tests/product_source/test_original_media_downloader.py::test_diagnostics_do_not_leak_sensitive_url_tokens PASSED [ 40%]
tests/product_source/test_original_media_downloader.py::test_byte_duplicate_collapse_leaves_no_orphan_files PASSED [ 42%]
tests/product_source/test_original_media_downloader.py::test_canonical_url_dedupe_before_download PASSED [ 44%]
tests/product_source/test_original_media_downloader.py::test_max_media_per_product_enforced PASSED [ 46%]
tests/product_source/test_scrape_tool_compat.py::test_shopee_scrape_tool_schema PASSED [ 48%]
tests/product_source/test_scrape_tool_compat.py::test_tiktok_scrape_tool_schema PASSED [ 51%]
tests/product_source/test_scrape_tool_compat.py::test_shopee_scrape_tool_passes_run_id_to_browser_manager PASSED [ 53%]
tests/product_source/test_scrape_tool_compat.py::test_tiktok_scrape_tool_passes_run_id_to_browser_manager PASSED [ 55%]
tests/product_source/test_scrape_tool_compat.py::test_tools_do_not_call_image_processor PASSED [ 57%]
...
tests/product_source/test_extractor_dom_fixtures.py: 3 warnings
