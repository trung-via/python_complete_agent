...
- **NEXT — fresh P7.1 real-evidence coverage baseline successor**: requires the explicit post-publication Human
  ...
  evidence and are permanently excluded from repaired baseline truth; do not continue, repair, or rehabilitate TASK-186 or TASK-188.
