...
5. **Selected-Variant Controls Observation (P6.3b / TASK-172 through TASK-175)**:
   - TASK-172 source hardening is CLOSED / PUBLISHED at `63525151e4dbb7a1c30454a301e3c0e20ae771e9`, TASK-173 live-DOM hardening is CLOSED / PUBLISHED at `f91dfe0f900664c835fef86bdf5d6c75879dbbdc`, and TASK-174 structural-depth hardening is CLOSED / PUBLISHED at `8c5a0b2a6a935c5bbecff5cde7b1a32956aa8d32`. A narrow Human-owned post-publication raw live recheck proved the selected DOM observation path sees exactly `Model: K550 Trắng Red V4` when the rendered selection is preserved. TASK-175 same-target acquisition-continuity hardening is CLOSED / PUBLISHED at `61f78f8ac1cd14e6e110552ba638eb9ca149403f`.
   ...
   - The published TASK-172 variation/radio controls and exact `selection-box-selected` / `selection-box-unselected` button class tokens share one all-or-nothing group coverage contract. TASK-174 permits only a finite bounded chain of transparent option-bearing wrappers to the nearest structurally proven direct semantic label-plus-option group. Gallery thumbnail masks, Quantity/stock, independent option branches, arbitrary higher text, and lower-page/add-on controls remain outside this boundary.
   ...
   - TASK-175 preserves an acquired page only when HTTP(S) host equality and the current URL path's existing Shopee product-id parser prove the same source product. Slug and query differences may reuse; blank, search, malformed, host-mismatched, challenge, different-product, and query-only identities still perform one exact target navigation. Reuse neither changes selected-variant admission nor treats model-like query parameters as truth.
   - Evidence/identity/truth separation: Selected-variant facts are observed source evidence only, not canonical variant identity or product truth. TASK-108 remains the sole pairwise relationship authority; TASK-116 governs Human exact-variant admission; TASK-171 reconciles descriptive product truth only after a canonical profile exists. The post-TASK-175 Human-owned live K550 checkpoint closed P6.3 under TASK-176, certifying the bounded selected-variant acquisition -> exact-variant relationship -> Human-governed canonical variant -> canonical profile -> descriptive-truth composition on that explicit current Shopee listing without broadening source evidence into canonical truth or certifying all DOMs/marketplaces.
