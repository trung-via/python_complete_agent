...
5. **Selected-Variant Controls Observation (P6.3b / TASK-172 through TASK-175)**:
   - TASK-172 source hardening is CLOSED / PUBLISHED at `63525151e4dbb7a1c30454a301e3c0e20ae771e9`, TASK-173 live-DOM hardening is CLOSED / PUBLISHED at `f91dfe0f900664c835fef86bdf5d6c75879dbbdc`, and TASK-174 structural-depth hardening is CLOSED / PUBLISHED at `8c5a0b2a6a935c5bbecff5cde7b1a32956aa8d32`. A narrow Human-owned post-publication raw live recheck proved the selected DOM observation path sees exactly `Model: K550 Trắng Red V4` when the rendered selection is preserved. TASK-175 is the current narrow P6.3b acquisition-continuity blocker because unconditional navigation cleared that rendered state before extraction.
   ...
   - Evidence/identity/truth separation: Selected-variant facts are observed source evidence only, not canonical variant identity or product truth. TASK-108 remains the sole pairwise relationship authority; TASK-116 governs Human exact-variant admission; TASK-171 reconciles descriptive product truth only after a canonical profile exists. Live `ProductSourcePack`, exact-variant, end-to-end, and product-truth certification remain downstream and are not claimed complete by TASK-175.
