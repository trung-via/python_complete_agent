...
K550 live certification passage. P7 Commerce Opportunity Intelligence is selected.
...
PASS and REVIEW-181-001 ChatGPT semantic PASS. TASK-182 / P7.1 is the real-evidence
coverage baseline gate. P6.4-P6.6 remain DEFERRED / UNIMPLEMENTED.
...
- **P7.0 Winning Product Evidence-Coverage Evaluation (TASK-181 — CLOSED / PUBLISHED)**
  freezes one pure bounded evaluator over existing `WinningProductScorer` outputs. It is published
  at source candidate `9e835ed2c551c2fa3a8b66b82caa238bd41b152c` after RUN-181-001
  canonical Runtime PASS and REVIEW-181-001 ChatGPT semantic PASS. It changes no discovery,
  normalization, scoring, ranking, approval, persistence, retrieval, truth, or collection authority.
- **P7.1 Real-Evidence Winning Product Coverage Baseline (TASK-182 — BASELINE WORK)**
  freezes one bounded three-query, fifteen-candidate Shopee search-card cohort and replays the
  published evaluator offline. It introduces no quality threshold, winner, approval, or automatic
  evidence-enrichment decision.
- **Post-baseline improvement selection remains separate**: longitudinal momentum,
  commercial/affiliate evidence, competition evidence, and semantic Contentability enrichment
  remain unselected until the TASK-182 source candidate has canonical Runtime PASS plus ChatGPT
  semantic-review PASS and Brain/Human authority separately interprets the measured evidence.

See `docs/PHASE_7_P7_0_WINNING_PRODUCT_EVIDENCE_QUALITY.md` for the closed evaluator
boundary and `docs/PHASE_7_P7_1_REAL_EVIDENCE_COVERAGE_BASELINE.md` for the measured baseline.
